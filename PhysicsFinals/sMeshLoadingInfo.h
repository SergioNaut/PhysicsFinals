...
namespace nGraphics
{
	...
	{
		sMeshLoadingInfo() : DoResize(false), DoRotate(false), Rotation(1.0f), StoreTriangleData(false), Extents(1.f, 1.f, 1.f), MaintainDimensions(true) {}
		...
		bool DoResize;
		// any rotating to be done?
		bool DoRotate;
		// rotation
		glm::mat3 Rotation;
		// store the triangle data?
		bool StoreTriangleData;
