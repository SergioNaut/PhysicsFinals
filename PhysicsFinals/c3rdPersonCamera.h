...
namespace nGraphics
{
	...
	public:
		...
		virtual glm::vec3 GetForwardAxis();
		virtual glm::vec3 GetRightAxis();
		virtual glm::vec3 GetUpAxis();
		virtual glm::vec3 GetEyePosition();
		...
		// Set the camera's distance from the target
